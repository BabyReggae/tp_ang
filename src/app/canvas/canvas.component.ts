...
//     E : { main : undefined, food : undefined, wall : undefined },//field elements like players , walls etc 
//     w : 3000,
//     h : 1200,
//     margin : 20,
...
//             },
//             update(){
//               this.curEl.forEach( function( el: { update: () => void; p: { x: any; y: any; }; w: any; getCollideBy: (arg0: any) => void; }, ind: any){
...
//             },
//             update(){
//               this.curEl.forEach( function( el: { update: () => void; p: { x: any; y: any; }; w: number; maxSize: number; getCollideBy: (arg0: any) => void; }, ind: any){
//                 //update is movement if needed
//                 el.update();
//                 //IS Collising with main ? 
//                 let iscollising  = field.E.main.collision( el.p.x, el.p.y, el.w );
...
//           },
//           update(){
//             this.curEl.forEach( function( el: { update: () => void; }, ind: any){
...
//     },
//     update : function( timeNow: number ){
...
//     w: number;
//     h: number;
//     p: { x: number; y: number; xPrev : number, yPrev : number };
//     displayPos: { x: number; y: number; xPrev : number, yPrev : number };
//     v: { x: number; y: number; };
//     bgColor: string;
//     borderColor: string;
...
//       this.w = 0;
//       this.h = 0;
//       this.p = { x : 0, y : 0 ,xPrev : 0, yPrev : 0};
//       this.displayPos = { x : 0, y : 0 ,xPrev : 0, yPrev : 0};
//       this.v = { x : 0, y : 0 };
...
//     speeding: number;
//     friction: number;
//     mm: { left: number; up: number; right: number; down: number; };
//     angle: number;
//     buffs: any[];
...
//         let dat = this;
//         $.each( this.mm , function(i: string | number,e: any){
//           //console.log( i , e );
...
//     collision(/*p1x, p1y, r1,*/ p2x: number, p2y: number, w2: number , h2: number /* this last param is set only if the 2nd element is an rectangle*/) 
//        {
...
//    {
//     constructor(x: undefined,y: undefined,w: undefined,h: undefined){
//       super(x,y,w,h);
...
//     getCollideBy( impactObj: { growChange: (arg0: number) => void; w: number; h: number; v: { x: number; y: number; }; } ){
//       // impactObj.buffs.push( new msNerf( field.timeNow, 1500, -2 ) );
...
//     duration: any;
//     timeLastUpd: any;
//     constructor( initTime: any, duration: any ){
...
//     value: any;
//     isEffective: boolean;
//     constructor( initTime: number , duration: number, buffVal: number){
//       super(initTime,duration);
//       this.value = buffVal;
//       this.isEffective = false;
//     }

//     applyOn( obj: { v: { x: any; y: any; }; } ){
...
//     removeOf( obj: { v: { x: number; y: number; }; } ){
//       if ( !this.isEffective ) return false;
//       obj.v.x -= this.value;
//       obj.v.y -= this.value;
//       this.isEffective = false;
...
//   $(window).on("keydown", function (e: { keyCode: string | number; }) { keys[e.keyCode] = true; console.log( e ) });//left start => 37 38 39 40
//   $(window).on("keyup", function (e: { keyCode: string | number; }) { keys[e.keyCode] = false; console.log( e )  });


//   function collision(p1x: number, p1y: number, r1: any, p2x: number, p2y: number, r2: any) 
//    {
